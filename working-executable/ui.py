...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def start_slicing(self):
        ...
        try:
            ...
            #my_file = "C:\\Users\\felix\\Download\\untitled.stl"
            #saved = "C:\\Users\\felix\\Desktop\\result.gcode"
            #config = "config_files/PrusaMini10.ini"
            
            #TODO Slice bash command
            #os.system(f"prusa-slicer-console.exe -g {my_file}")
            print(f"{self.get_slicer_path()} -g  {self.print_file_stl} -o {save_path[0]} --load config_files/{self.cb_profile.currentText()}")
